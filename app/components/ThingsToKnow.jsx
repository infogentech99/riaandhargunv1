                    ...
                    <div className="flex justify-center mt-20 pb-24">
                        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 lg:gap-24 gap-10 sm:gap-16">
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <h2 className="text-2xl text-[#DEE6FF] mt-2 font-cormorant-upright">Weather</h2>
                            ...
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <h2 className="text-2xl text-[#DEE6FF] mt-2 font-cormorant-upright">Staff</h2>
                            ...
                            <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <h2 className="text-2xl text-[#DEE6FF] mt-2 font-cormorant-upright">Parking</h2>
                                <p className="text-[16px] text-[#DEE6FF] mt-1 font-cormorant">
