    ...
    return (
        ...
        <div className="bg-[url('/assets/backmid.png')] bg-cover bg-no-repeat bg-[#1BB1BB]">
            <div className="lg:h-465 md:h-290 h-380">
                ...
                <h2 className="lg:text-[30px] text-[16px] text-center text-white lg:px-60 px-6 lg:mt-28 mt-12 font-cormorant-upright leading-8">From different traditions to one beautiful journey, join us as we celebrate love, laughter, and forever.
